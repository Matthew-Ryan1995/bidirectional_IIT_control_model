...
if(!dir.exists((glue::glue("outputs/intervention_simulations/{param_list$parameter_set}")))){
  dir.create((glue::glue("outputs/intervention_simulations/{param_list$parameter_set}")))
}
