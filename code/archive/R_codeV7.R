# Matt Ryan
# Implementing steady state parameters for multi-class male system
...
# maleDeathRate <- 2e-2
# femaleDeathRate <- 1e-2

# To play
carryingCapacityByPopulation_vector[1] <- 400
# numMaleClasses[1] <- numMaleClasses[2] <- 1
...
deathRatesByName_vector[ind] <- maleDeathRate[1] #don't edit # fixme: hardcoded index
ind <- getIndicesForStateQuery(stateNames, populationName = populationNames, genotype = "wPip", sex = "m", ageClass = NA, mate = NA) #don't edit
deathRatesByName_vector[ind] <- maleDeathRate[2] #don't edit # fixme: hardcoded index
...
birthRateByName_vector[ind] <- femaleBirthRate[1] #don't edit # fixme: hardcoded index
...
birthRateByName_vector[ind] <- femaleBirthRate[2] #don't edit # fixme: hardcoded index
